...
1. Launch `sdd-executor` with phase `explore` and the installed `sdd-explore/SKILL.md`
2. Present the exploration summary to the user
3. Launch `sdd-executor` with phase `propose` and the installed `sdd-propose/SKILL.md`
